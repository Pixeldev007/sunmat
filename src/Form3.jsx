...
const FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLScmMcskhgWsTMgHQivvbHz0O0DNhnsE0_0_p-_1VSQ3ICTqRg/viewform?usp=sharing";
    ...
    >
      <div className="w-full max-w-3xl bg-white/70 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/60 p-5 sm:p-8 md:p-10">
        ...
        >
          ...
          பொருத்தமான <strong style={{ fontSize: "22px" }}>10</strong> வரன் விபரங்களை போன் நம்பருடன் தபால் மூலம் அனுப்புகிறோம்.
          <br />
          2.வரன்களை தபாலில் பெற்றபின் தபால்காரரிடம் ரூ <strong style={{ fontSize: "22px" }}>500</strong> [COD] செலுத்தினால் போதும்.
        </p>
